(function (global, factory) {
	...
	var apexcharts_min = createCommonjsModule(function (module, exports) {
	  /*!
	   * ApexCharts v3.35.0
	  ...
	  !function (t, e) {
	    ...
	    var C = {
	      ...
	      return r(t, [{
	        ...
	        value: function (t, e, i) {
	          ...
	          var o = Math.abs(i - e);
	          if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(e, i, r.logBase);else if (i !== -Number.MAX_VALUE && x.isNumber(i)) {
	    ...
	    It = "undefined" != typeof window ? window : void 0, zt = function (t, e) {
	      ...
	      return a;
	    }, "object" === (i(exports)) && "undefined" != 'object' ? module.exports = It.document ? zt(It, It.document) : function (t) {
	...
	var ApexChartsComponent = {
	  ...
	  beforeMount: function beforeMount() {
	    window.ApexCharts = apexcharts_min;
	  },
	  ...
	  methods: {
	    init: function init() {
	      ...
	      this.chart = new apexcharts_min(this.$el, config);
	...
	VueApexCharts.install = function (Vue) {
	  ...
	  Vue.ApexCharts = apexcharts_min;
	  window.ApexCharts = apexcharts_min; // add the instance method

	  Object.defineProperty(Vue.prototype, '$apexcharts', {
	    get: function get() {
	      return apexcharts_min;
	    }
	  });
	};
